...
public partial class RetailOrderingContext : DbContext
{
    public RetailOrderingContext()
    {
    }

    public RetailOrderingContext(DbContextOptions<RetailOrderingContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CartItem>(entity =>
        {
            ...
            entity.HasIndex(e => e.CartId, "idx_cart");
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "idx_order");
            ...
            entity.Property(e => e.Status)
                .HasColumnType("enum('PLACED','CONFIRMED','PREPARING','OUT_FOR_DELIVERY','DELIVERED','CANCELLED')")
        ...
        modelBuilder.Entity<OrderItem>(entity =>
        {
            ...
            entity.HasIndex(e => e.OrderId, "idx_order_items");
